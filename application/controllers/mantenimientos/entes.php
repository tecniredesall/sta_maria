 ...
 */
  ...
  */
        public function  __construct()
        {
            ...
            $this->modelo='entes_model';
            $this->ruta='/mantenimientos/entes';
            $this->plantilla="principal";
            $this->vista="mantenimientos/entes";
            $this->campos=array("Nombre Entidad"=>"nombre");
