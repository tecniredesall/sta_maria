 ...
 */
  ...
  */
        public function  __construct()
        {
            ...
            $this->modelo='desccursos_model';
            $this->ruta='/infocursos/cursos';
            $this->plantilla="principal";
            $this->vista="infocursos/cursos";
            $this->campos=array("Nombre"=>"nombre","Descripción"=>"observaciones");
