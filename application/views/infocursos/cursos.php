...
<?= form_open(instancia_controller()->ruta.instancia_controller()->accion, array('id' => 'form_nivel', 'autocomplete' => "off")) ?>
       ...
       <div class="formulario">
            <div class="div_encabezado_formulario" >
                <span class="span_text_formulario">Agregar Definición de Cursos</span>
                <hr class="hr_titulo_formulario"/>
            </div>
            <table align="center" cellpadding="3" cellspacing="3" border="0">
                <tr>
                    <td>Nivel</td>
                    <td><?php $nivel=form_dropdown_autoload(array("mantenimientos/nivel",array("id","valor")), array(),'class="req_cmb"',array('modelo'=>instancia_controller()->modelo,'autoload'=>TRUE,'name'=>'nivel_id',"guardar"=>TRUE)); ?></td>
                </tr>
                  <tr>
                    <td>Modulos:</td>
                    <td><?php form_dropdown_autoload(array("mantenimientos/modulos",array("id","valor"),"getModulos",array("padre_id"=>$nivel['value'])), array(),'class="req_cmb"',array('modelo'=>instancia_controller()->modelo,'autoload'=>TRUE,'name'=>'modulos_id',"guardar"=>TRUE),$nivel); ?></td>
                </tr>
                <tr>
                    <td>Nombre:</td>
