...
<?= form_open(instancia_controller()->ruta.instancia_controller()->accion, array('id' => 'form_nivel', 'autocomplete' => "off")) ?>
       ...
       <div class="formulario">
            <div class="div_encabezado_formulario" >
                <span class="span_text_formulario">Agregar Unidades a Cursos</span>
                <hr class="hr_titulo_formulario"/>
            </div>
            <table align="center" cellpadding="3" cellspacing="3" border="0">
                <tr>
                    <td>Curso</td>
                    <td><?php $nivel=form_dropdown_autoload(array("infocursos/cursos",array("id","valor")), array(),'class="req_cmb"',array('modelo'=>instancia_controller()->modelo,'autoload'=>TRUE,'name'=>'desc_cursos_id',"guardar"=>TRUE)); ?></td>
                </tr>
                <tr>
                    <td>Nombre:</td>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td><?php echo form_input_autoload(array("class"=>'req_txt numeros form', 'maxlength' => '20'),'','',array('modelo'=>instancia_controller()->modelo,'name'=>'horas')); ?></td>
                </tr>
