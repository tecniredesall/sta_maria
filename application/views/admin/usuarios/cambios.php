...
<?= form_open(instancia_controller()->ruta.instancia_controller()->accion, array('id' => 'form_usuarios', 'autocomplete' => "off")) ?>
            ...
            <div class="div_encabezado_formulario" >
                <span class="span_text_formulario">Cambiar Parametros</span>
                <hr class="hr_titulo_formulario"/>
            </div>
            <table align="center" cellpadding="3" cellspacing="3" border="0">
                <tr>
                    <td>Usuario:</td>
                    <td><?php echo form_input_autoload(array("class"=>'req_txt alfa form',"readonly"=>"readonly",'size' => '40', 'maxlength' => '12'),'','',array('modelo'=>instancia_controller()->modelo,'name'=>'usuario')); ?></td>
                </tr>
                <tr>
                    <td>Clave Antigua:</td>
                    <td><?php echo form_input_autoload(array("class"=>'req_txt alfa form','size' => '40', 'maxlength' => '16',"type"=>"password"),'','',array('name'=>'clave_old')); ?></td>
                </tr>
                <tr>
                    <td>Clave:</td>
...
<? echo form_close() ?>
    <?php
            ...
            table($obj->data['campos'],array(),$obj->data['datatabla'],'id_data_table',array("eliminar"=>array("permiso"=>$obj->eliminar),"actualizar"=>array("permiso"=>$obj->modificar),"otro"=>array("href"=>"/bloquear/","titulo"=>"Bloquear/Desbloquear usuario","target"=>"_self","src"=>base_url()."img/iconos/candado.gif")),array(),$obj->imprimir);
    ?>