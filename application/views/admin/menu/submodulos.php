...
<?= form_open(instancia_controller()->ruta.instancia_controller()->accion, array('id' => 'form_submodulos', 'autocomplete' => "off")) ?>
            ...
            <div class="div_encabezado_formulario" >
                <span class="span_text_formulario">Agregar Menu&nbsp;(2 Nivel)</span>
                <hr class="hr_titulo_formulario"/>
            </div>
            <table align="center" cellpadding="3" cellspacing="3" border="0">
                <tr>
                    <td>Modulo:</td>
                    <td><?php form_dropdown_autoload(array("admin/menu/modulos",array("id","valor")), array(),'class="req_cmb"',array('modelo'=>instancia_controller()->modelo,'name'=>'menumodulos_id',"guardar"=>TRUE)); ?></td>
                </tr>
                <tr>
                    <td>Nombre:</td>
