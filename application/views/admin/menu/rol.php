...
<?= form_open(instancia_controller()->ruta.instancia_controller()->accion, array('id' => 'form_participantes', 'autocomplete' => "off")) ?>
       ...
       <div class="formulario">
            <div class="div_encabezado_formulario" >
                <span class="span_text_formulario">Agregar Roles</span>
            ...
            <table align="center" cellpadding="3" cellspacing="3" border="0">
                ...
                <tr>
                    <td>Descripcion:</td>
                    <td><?php echo form_textarea_autoload(array("class"=>'form', 'maxlength' => '150'),'','',array('modelo'=>instancia_controller()->modelo,'name'=>'descripcion')); ?></td>
                </tr>
                <tr>
