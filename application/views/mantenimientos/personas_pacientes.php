...
<?= form_open(instancia_controller()->ruta.instancia_controller()->accion, array('id' => 'form_participantes', 'autocomplete' => "off")) ?>
            ...
            <table align="center" cellpadding="3" cellspacing="3" border="0">
                <tr>
                    <td>Cedula:</td>
                    <td><?php echo form_input_autoload(array("class"=>'req_txt mask_cedula form','size' => '40', 'maxlength' => '15'),'','',array('modelo'=>instancia_controller()->modelo,'name'=>'cedula')); ?></td>
                </tr>
                <tr>
                    <td>Nombre:</td>
                ...
                <tr>
                    ...
                    <td><?php echo form_input_autoload(array("class"=>'req_txt req_telefono form', 'maxlength' => '20'),'','',array('modelo'=>instancia_controller()->modelo,'name'=>'tlf_celular')); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Estado:</td>
                    <td><?php $estado=form_dropdown_autoload(array("mantenimientos/estados",array("id","nombre")), array(),'class="req_cmb"',array('modelo'=>instancia_controller()->modelo,'autoload'=>TRUE,'name'=>'estados_id',"guardar"=>TRUE)); ?></td>
                </tr>
                <tr>
                    <td>Ciudad:</td>
