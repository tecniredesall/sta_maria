...
<?= form_open(instancia_controller()->ruta.instancia_controller()->accion, array('id' => 'form_participantes', 'autocomplete' => "off")) ?>
       ...
       <div class="formulario">
            <div class="div_encabezado_formulario" >
                <span class="span_text_formulario">Agregar Espacios&nbsp;(Laboratorios)</span>
            ...
            <table align="center" cellpadding="3" cellspacing="3" border="0">
                ...
                <tr>
                    <td>Capacidad</td>
                    <td><?php echo form_input_autoload(array("class"=>'req_txt numeros form','size' => '40', 'maxlength' => '2'),'','',array('modelo'=>instancia_controller()->modelo,'name'=>'cant')); ?></td>
                </tr>
                <tr>
                    <td>Estado:</td>
                ...
                <tr>
                    <td>Unidad Adscrita:</td>
                    <td><?php form_dropdown_autoload(array("mantenimientos/entes",array("id","valor")), array(),'class="req_cmb"',array('modelo'=>instancia_controller()->modelo,'autoload'=>TRUE,'name'=>'entes_id',"guardar"=>TRUE)); ?></td>
                </tr>
                <tr>
                    <td>Dirección:</td>
                    <td><?php echo form_textarea_autoload(array("class"=>'req_area','size' => '20', 'maxlength' => '250'),'','',array('modelo'=>instancia_controller()->modelo,'name'=>'direccion')); ?></td>
                </tr>
                <tr>
