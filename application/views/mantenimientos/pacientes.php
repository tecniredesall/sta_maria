...
<?= form_open(instancia_controller()->ruta.instancia_controller()->accion, array('id' => 'form_participantes', 'autocomplete' => "off")) ?>
            ...
            <div class="div_encabezado_formulario" >
                <span class="span_text_formulario">Verificar Cedula (Agregar Pacientes)</span>
                <hr class="hr_titulo_formulario"/>
            </div>
            <table align="center" cellpadding="3" cellspacing="3" border="0">
                <tr>
                    <td>Cedula</td>
                    <td><?php echo form_input_autoload(array("class"=>'req_cedula','size' => '40', 'maxlength' => '12'),'','',array('modelo'=>instancia_controller()->modelo,'name'=>'cedula')); ?></td>
                </tr>
                <tr>
                    <td>Codigo Paciente</td>
                    <td><?php echo form_input_autoload(array("class"=>'req_integer','size' => '40', 'maxlength' => '12'),'','',array('modelo'=>instancia_controller()->modelo,'name'=>'referencia')); ?></td>
                </tr>
                <tr>
